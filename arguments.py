...
parser.add_argument("--ppo_epoch", type=int, default=4, help="Number of PPO epochs.")
parser.add_argument(
...
parser.add_argument(
    "--clip_value_loss", type=str2bool, default=False, help="PPO value loss clipping."
)
parser.add_argument(
    "--clip_reward",
    type=float,
...
parser.add_argument(
    "--use_warmup_level_replay",
    type=str2bool,
    nargs="?",
    const=True,
    default=False,
    help="Enable a dedicated PLR buffer during opponent replay warmup stage.",
)
parser.add_argument(
    "--warmup_level_replay_seed_buffer_size",
    type=int,
    default=8000,
    help="Seed buffer size for the dedicated warmup replay PLR buffer.",
)
...
parser.add_argument(
    "--clearml_task", type=str, default="dcd-ctrlsim", help="ClearML task name."
)
parser.add_argument(
