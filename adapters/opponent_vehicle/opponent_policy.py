...
class OpponentPolicyService:
    ...
    def _create_policy(self) -> AutoregressivePolicy:
        ...
        if self.adapter.per_vehicle_tilting is not None:
            tilt_dict = {
                ...
                "per_vehicle": self.adapter.per_vehicle_tilting,
            }
    ...
    def set_tilting(
        ...
        if self.adapter._policy is not None:
            self.adapter._policy.tilt_dict = self.adapter.current_tilt.to_dict()
    ...
    def set_per_vehicle_tilting(self, mapping: Dict[int, Tuple[int, int, int]]):
        ...
        if self.adapter._policy is not None:
            self.adapter._policy.tilt_dict = {
                "tilt": True,
                "goal_tilt": self.adapter.current_tilt.goal_tilt,
                "veh_veh_tilt": self.adapter.current_tilt.veh_veh_tilt,
                "veh_edge_tilt": self.adapter.current_tilt.veh_edge_tilt,
            ...
            self.adapter._policy.goal_tilt = self.adapter.current_tilt.goal_tilt
            self.adapter._policy.veh_veh_tilt = self.adapter.current_tilt.veh_veh_tilt
            self.adapter._policy.veh_edge_tilt = self.adapter.current_tilt.veh_edge_tilt
