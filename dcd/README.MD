...
![DCD overview diagram](/vibe/docs/images/dcd_overview.png#gh-light-mode-only)
![DCD overview diagram](/vibe/docs/images/dcd_overview_darkmode.png#gh-dark-mode-only)
...
![Example mazes](/vibe/docs/images/ood_mazes.png)
...
![CarRacingBezier tracks](/vibe/docs/images/car_racing_bezier_tracks.png)
...
#### `CarRacingF1`
![CarRacingF1 tracks](/vibe/docs/images/f1_benchmark_tracks.png)
...
![Example BipedalWalker environments](/vibe/docs/images/bipedal_challenges.png)
...
![Example ACCEL BipedalWalker agent on challenging terrain](/vibe/docs/images/accel_bipedal_demo.gif)
