...
class Object : public ObjectBase {
 public:
  ...
  virtual void set_heading(float heading) { heading_ = heading; }

  float speed() const { return speed_; }
  virtual void set_speed(float speed) { speed_ = ClipSpeed(speed); }
  ...
  virtual void set_steering(float steering) { steering_ = steering; }
  ...
  void set_expert_control(bool expert_control) {
    ...
    CreatePhysicsBody();  // update physics simulation
  }

  bool physics_simulated() const { return physics_simulated_; }
  void set_physics_simulated(bool physics_simulated) {
    physics_simulated_ = physics_simulated;
    CreatePhysicsBody();  // update physics simulation
  }
 ...
 protected:
  ...
  // If true the object is controlled by its physics model
  bool physics_simulated_ = false;
